    ...
    for (let i = 0; i <= ruleLinesNb; i++) {
      if (i % 5 == 0) {
        if (i % 10 == 0) {
          components.push(
            <path
              ...
              d={this.getHorizontalLinePath(i, 12, zoomedGridSize, this.state.rulerHeight)}
          ...
          components.push(
            <path
              key={this.randomIdGenerator.generate()}
              d={this.getHorizontalLinePath(i, 10, zoomedGridSize, this.state.rulerHeight)}
              stroke={this.state.color}
            />
          );
        }
        ...
        components.push(
          <path
            key={this.randomIdGenerator.generate()}
            d={this.getHorizontalLinePath(i, 15, zoomedGridSize, this.state.rulerHeight)}
            stroke={this.state.color}
          />
        );
      }
